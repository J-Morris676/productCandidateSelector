...
appModule.service("instancesService", ["$http", "$q", function ($http, $q) { return new app.services.apiServices.InstancesService($http, $q); }]);
appModule.service("relationshipsService", ["$http", "$q", function ($http, $q) { return new app.services.apiServices.RelationshipsService($http, $q); }]);
...
appModule.controller("selectController", ["$scope", "instancesService", "relationshipsService", "specificationDataGenerationService", "$filter", function ($scope, instancesService, relationshipsService, specificationDataGenerationService, $filter) { return new app.controllers.selectController($scope, instancesService, relationshipsService, specificationDataGenerationService, $filter); }]);
