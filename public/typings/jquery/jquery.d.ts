...
interface JQuery {
     ...
     *
     * @param className One or more space-separated modules to be added to the class attribute of each matched element.
     */
    ...
    /**
     * Remove a single class, multiple modules, or all modules from each element in the set of matched elements.
     *
     * @param className One or more space-separated modules to be removed from the class attribute of each matched element.
     */
    ...
    /**
     * Add or remove one or more modules from each element in the set of matched elements, depending on either the class's presence or the value of the switch argument.
     *
