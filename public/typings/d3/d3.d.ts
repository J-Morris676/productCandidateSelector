...
declare module d3 {
    ...
    module selection {
        ...
        interface Update<Datum> {
            ...
            /**
             * Returns true if the first node in this selection has the given class list. If multiple modules are specified (i.e., "foo bar"), then returns true only if all modules match.
             *
             ...
             *
             * @param name The class list to toggle. Spaces separate class names: "foo bar" is a list of two modules.
             * @param value If true, add the modules. If false, remove them.
             */
            ...
            /**
             * Set or derive modules for multiple class lists at once.
             *
